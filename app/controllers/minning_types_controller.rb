class MinningTypesController < ApplicationController
  before_action :set_minning_type, only: %i[ show edit update destroy ]

  # GET /minning_types or /minning_types.json
  def index
    @minning_types = MinningType.all
  end

  # GET /minning_types/1 or /minning_types/1.json
  def show
  end
  ...
  # POST /minning_types or /minning_types.json
  def create
    @minning_type = MinningType.new(minning_type_params)

    respond_to do |format|
      if @minning_type.save
        format.html { redirect_to minning_type_url(@minning_type), notice: "Minning type was successfully created." }
  ...
  # PATCH/PUT /minning_types/1 or /minning_types/1.json
  def update
    respond_to do |format|
      if @minning_type.update(minning_type_params)
        format.html { redirect_to minning_type_url(@minning_type), notice: "Minning type was successfully updated." }
  ...
  # DELETE /minning_types/1 or /minning_types/1.json
  def destroy
